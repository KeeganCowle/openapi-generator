...
class TestFormObjectMultipartRequestMarker(BaseModel):
    ...
    # Deprecated. Use TestFormObjectMultipartRequestMarker.model_validate_json(json_str)
    # @classmethod
    # def from_json(cls, json_str: str):

    # Deprecated. Use TestFormObjectMultipartRequestMarker.model_validate(obj)
    # @classmethod
