...
class FakeApi:
    ...
    def test_endpoint_parameters(
        ...
        pattern_without_delimiter: Annotated[str, Field(description="None", strict=True)],
        ...
        string: Annotated[Optional[str], Field(description="None")] = None,
        ...
        password: Annotated[Optional[Annotated[str, Field(min_length=10, max_length=64)]], Field(description="None")] = None,
