...
class TestErrorResponsesWithModel400Response(BaseModel):
    ...
    # Deprecated. Use TestErrorResponsesWithModel400Response.model_validate_json(json_str)
    # @classmethod
    # def from_json(cls, json_str: str):

    # Deprecated. Use TestErrorResponsesWithModel400Response.model_validate(obj)
    # @classmethod
