...
class AdditionalPropertiesWithDescriptionOnly(BaseModel):
    ...
    # Deprecated. Use AdditionalPropertiesWithDescriptionOnly.model_validate_json(json_str)
    # @classmethod
    # def from_json(cls, json_str: str):

    # Deprecated. Use AdditionalPropertiesWithDescriptionOnly.model_validate(obj)
    # @classmethod
