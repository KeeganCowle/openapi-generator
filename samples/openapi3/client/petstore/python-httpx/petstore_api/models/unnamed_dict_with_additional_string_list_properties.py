...
class UnnamedDictWithAdditionalStringListProperties(BaseModel):
    ...
    # Deprecated. Use UnnamedDictWithAdditionalStringListProperties.model_validate_json(json_str)
    # @classmethod
    # def from_json(cls, json_str: str):

    # Deprecated. Use UnnamedDictWithAdditionalStringListProperties.model_validate(obj)
    # @classmethod
