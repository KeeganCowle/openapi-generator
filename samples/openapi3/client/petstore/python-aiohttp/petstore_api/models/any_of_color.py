...
class AnyOfColor(BaseModel):
    ...
    # data type: str
    anyof_schema_3_validator: Optional[Annotated[str, Field(min_length=7, max_length=7)]] = Field(default=None, pattern="/^#(?:[0-9a-fA-F]{3}){1,2}$/", description="Hex color string, such as #00FF00.")
    if TYPE_CHECKING:
