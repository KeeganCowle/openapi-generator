...
class TestInlineFreeformAdditionalPropertiesRequest(BaseModel):
    ...
    # Deprecated. Use TestInlineFreeformAdditionalPropertiesRequest.model_validate_json(json_str)
    # @classmethod
    # def from_json(cls, json_str: str):

    # Deprecated. Use TestInlineFreeformAdditionalPropertiesRequest.model_validate(obj)
    # @classmethod
