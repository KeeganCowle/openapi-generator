...
class TestObjectForMultipartRequestsRequestMarker(BaseModel):
    ...
    # Deprecated. Use TestObjectForMultipartRequestsRequestMarker.model_validate_json(json_str)
    # @classmethod
    # def from_json(cls, json_str: str):

    # Deprecated. Use TestObjectForMultipartRequestsRequestMarker.model_validate(obj)
    # @classmethod
