...
class MixedPropertiesAndAdditionalPropertiesClass(BaseModel):
    ...
    # Deprecated. Use MixedPropertiesAndAdditionalPropertiesClass.model_validate_json(json_str)
    # @classmethod
    # def from_json(cls, json_str: str):

    # Deprecated. Use MixedPropertiesAndAdditionalPropertiesClass.model_validate(obj)
    # @classmethod
